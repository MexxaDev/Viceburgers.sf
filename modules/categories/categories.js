          ...
          <tbody>
            ${this.categories
              ...
              <tr>
                ...
                <td>
                  <span style="display:inline-block;width:16px;height:16px;background:${escapeHtml(cat.color)};border-radius:4px;"></span>
                </td>
                <td>
  ...
  openModal(category = null) {
    ...
    const body = `
      <div class="form-group">
        ...
        <input type="text" class="form-input" id="cat-name" value="${safeName}" required>
      </div>
      <div class="form-group">
        <label class="form-label">Descripción</label>
        <input type="text" class="form-input" id="cat-desc" value="${safeDesc}">
      </div>
      <div class="form-group">
        <label class="form-label">Color</label>
        <input type="color" class="form-input" id="cat-color" value="${safeColor}">
      </div>
    `;
